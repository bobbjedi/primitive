module.exports = {
    ...
    cripts: {
        red: {
            points: [
                {x: -4, y: 1.2, z: -80 }, // респ
                {x: -12, y: 1.2, z: -71}, // выход через бок
                {x: -4, y: 1.2, z: -40}, // к центральной дороге
                { x: -4, y: 1.2, z: 40 }, // к центральной дороге на стороне противника
                { x: -12, y: 1.2, z: 71 }, // вход через бок
